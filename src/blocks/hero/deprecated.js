...
const deprecated = [
	{
		...
		// v1 (apiVersion 1) markup, verbatim copy of the pre-migration `save.js`
		// before the switch to `useBlockProps.save()` for Block API v3.
		// Kept so existing content continues to validate.
